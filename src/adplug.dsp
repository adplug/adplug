...
!MESSAGE 
!MESSAGE "adplug - Win32 Release" (based on "Win32 (x86) Static Library")
!MESSAGE "adplug - Win32 Debug" (based on "Win32 (x86) Static Library")
!MESSAGE 
...
# ADD CPP /nologo /Zp1 /MD /W3 /GX /O2 /D "NDEBUG" /D "WIN32" /D "_MBCS" /D "_LIB" /FD /c
# SUBTRACT CPP /YX
